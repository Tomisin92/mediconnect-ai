...
# # Backend connection status - REMOVED
...
#             "backend_connected": "Always Ready",
...
#             "Select Endpoint",
#             ["/health", "/start_consultation", "/continue_consultation", "/stats", "/test-openai"]
#         )
...
#         elif test_endpoint == "/test-openai":
#             if st.button("Test OpenAI Connection", key="test_openai_endpoint"):
#                 try:
#                     response = requests.get(f"{API_BASE_URL}/test-openai")
#                     st.write(f"Status: {response.status_code}")
#                     result = response.json()
#                     st.json(result)
                    
#                     # Show specific OpenAI status
#                     if result.get("openai_connected"):
#                         st.success("✅ OpenAI is working properly!")
#                     else:
#                         st.error(f"❌ OpenAI Issue: {result.get('message', 'Unknown error')}")
